#!/usr/bin/env python3
""" Test SUITE Unittest for module Task """
...
class TestAccessNestedMap(TestCase):
    """the Class for testing Nested Map function """
    ...
    def test_access_nested_map(self, map, path, expected_output):
        """This is Test method return output """
    ...
    def test_access_nested_map_exception(self, map, path, wrong_output):
        """This Test method raises correct exception """
...
class TestGetJson(TestCase):
    """The Class for testing get_json function """
    ...
    def test_get_json(self, test_url, test_payload):
        """This Test method returns correct output """
